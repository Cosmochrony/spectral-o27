...
\begin{document}
  ...
  \begin{remark}[Scope of Proposition~\ref{prop:hilbert}]
    ...
    of Lemma~\ref{lem:quotient}, the dimension count $\dim_{\mathbb{R}} H_{\mathrm{eff}} = 3$ of O23
    Theorem~3.2~\cite{Beau2026a27}, and the classical uniqueness of $\mathbb{H}$ (Frobenius
