...
\begin{document}
  ...
  Born--Infeld parity as an equivariant symmetry and states the fibre identification as an
...
The second is partly open: O18~\cite{Beau2026a22} proves Born--Infeld parity as an
equivariant symmetry, but the identification of the parity orbit with a fibre of $\Pi$
