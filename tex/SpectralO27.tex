...
\begin{document}
  ...
  \subsection{Relation to the O-series chain}
    ...
    The transfer $c_{\mathrm{BI}} \to \delta_{\mathrm{pair}} \to \beta^*$ was proved unconditionally in
...
properties specific to any prime $q$.
  ...
  \begin{corollary}[Representation-theoretic meaning of $\beta^*$]
    \label{cor:beta}
    Under the unconditional transfer $c_{\mathrm{BI}} \to \delta_{\mathrm{pair}} \to \beta^*$ of
    O24~\cite{Beau2026a28}, the exponent $\beta^*$ is the effective scaling exponent of norm growth
