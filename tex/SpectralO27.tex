...
\begin{document}
  ...
  \begin{abstract}
    ...
    must factor.
    Combined with the chain $c_\chi \to \delta_{\mathrm{pair}} \to \beta^*$ of
  ...
  \sigma_c(n) \cdot \sigma_{q-c}(n)$ as the Hilbert--Schmidt norm squared of a rank-one operator
    ...
    \subsection{Relation to the O-series chain}
      ...
      The transfer $c_\chi \to \delta_{\mathrm{pair}} \to \beta^*$ was proved unconditionally in
...
properties specific to any prime $q$.
  ...
  \section{Representation-Theoretic Interpretation of $\beta^*$}
    ...
    \begin{corollary}[Representation-theoretic meaning of $\beta^*$]
      \label{cor:beta}
      Under the unconditional transfer $c_\chi \to \delta_{\mathrm{pair}} \to \beta^*$ of
